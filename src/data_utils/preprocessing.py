...
def encode_sapo(news_df: pd.DataFrame = None, tokenizer: PreTrainedTokenizer = None):
    '''
    ...
    try:
        ...
        for sapo_element in sapo_list:
            sapo_encoding = tokenizer.encode(sapo_element, add_special_tokens=True, truncation=True,
        ...
        log.error("Failed to encode sapo col information to vector using pre-train language models")
        return False, None

def encode_titles(news_df: pd.DataFrame = None, tokenizer: PreTrainedTokenizer = None):
    '''
    ...
    try:
        ...
        for title_element in title_list:
            title_encoding = tokenizer.encode(title_element, add_special_tokens=True, truncation=True,
        ...
        log.error("Failed to encode title col information to vector using pre-train language models")
        return False, None

def encode_news_data(news_path: str = None, tokenizer: PreTrainedTokenizer = None):
    '''
    ...
    try:
        ...
        title_check_flag, encoding_title_list = encode_titles(news_df, tokenizer)
        if sapo_check_flag:
